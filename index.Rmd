...
## Machine Learning
As stated before we chose Random Forest as the algorithm. Before running caret's **train** function we reserve 20 cores to be used in our server, since we already antecipate a lot of processing. We also creat a **trainControl** object to specify 10-Fold Cross Validation one time and pass it to the **train** function. Then our code to create the model is:
